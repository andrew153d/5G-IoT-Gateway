...
class n71(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "n71", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("n71")
        ...
        self.settings = Qt.QSettings("GNU Radio", "n71")
        ...
        self._rf_gain_range = Range(0, 60, 1, 15, 200)
        ...
        self._freq_range = Range(100e6, 6000e6, 1e6, 680e6, 200)
        ...
        self._variable_qtgui_label_0_tool_bar.addWidget(Qt.QLabel("Power(dBm)"))
        ...
        self.connect((self.blocks_nlog10_ff_0, 0), (self.level, 0))
...
def main(top_block_cls=n71, options=None):
